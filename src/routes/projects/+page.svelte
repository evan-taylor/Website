<script>
  ...
  const projects = [
    ...
    },
    {
      ...
      title: "Auxos",
      description:
        "Creating a lightly gamified productivity and accountability platform that helps users achieve personal growth through goal tracking and trusted circles.",
